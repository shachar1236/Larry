...
public:
    ...
    virtual void ButtonJustPressed(
        const ECS::Entity&, Events::KeyPressedEvent*) { }; // Called when a button was first pressed
    virtual void ButtonReleased(const ECS::Entity&, Events::KeyReleasedEvent*) { }; // Called when a button was released
    virtual void MouseJustPressed(
        const ECS::Entity&, Events::MousePressedEvent*) { }; // Called when one of the mouse first  buttons was pressed
    virtual void MouseScrolled(
        const ECS::Entity&, Events::MouseScrolledEvent*) { }; // Called when one of the mouse was scrolled
                                                              //
